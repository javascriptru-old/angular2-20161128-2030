import { Component, Input, HostListener, ViewContainerRef, ViewChild, ElementRef  } from '@angular/core';
...
export class TypeaheadDirective  {
  ...
  @Input() typeaheadService: ITypeahead;
  ...
  private selectItem(value:string) {
    ...
    this.viewContainerRef.element.nativeElement.value = this._filterValue;
