...
export class AppComponent {
 ...
 public onTimer() {
  ...
  // private cityGenerator(cnt: number, weather: IWeatherItem): Array<ICityItem> {
  //   let res: Array<ICityItem>= [];
  //   for(let i=0;i<cnt;i++)
  //   {
  //       let c1: ICityItem = {
  //           name: 'city1',
